    ...
    public static void updatePlayer(Player player) {
        if (player.iDMark.isLoadedAllDataPlayer()) {
            ...
            try {
                ...
                String query = " update player set diem_huy_diet=?,diem_thien_su=?, data_item_time_sieu_cap = ?, head = ?, have_tennis_space_ship = ?,"
                ...
                GirlkunDB.executeUpdate(query,
                        player.getSession().diem_huy_diet,
                        player.getSession().diem_thien_su,
                        itemTimeSC,
                        player.head,
