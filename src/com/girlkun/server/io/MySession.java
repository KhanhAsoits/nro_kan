...
public class MySession extends Session {
    ...
    public int diem_huy_diet;
    public int diem_thien_su;
        ...
        if (this.player != null) {
            ...
            try {
                ...
                if (player != null) {
                    ...
                    player.getSession().diem_huy_diet = player.diem_huy_diet;
                    player.getSession().diem_thien_su = player.diem_thien_su;
