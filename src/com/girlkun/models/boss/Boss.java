...
//        System.out.println("this status: " + this.bossStatus + " (" + this.id + ")");
    ...
    public void die(Player plKill) {
        if (plKill != null) {
            ...
            this.bossDieNotification(plKill);
        }
        this.changeStatus(BossStatus.DIE);
    }

    public void bossDieNotification(Player player) {
        Logger.log(String.format("Boss %s đã bị tiêu diệt bởi %s", this.name, player.name));
    }
...
//        System.out.println(String.format("Boss %s vừa bị %s tiêu diệt", this.name, ));
    }
