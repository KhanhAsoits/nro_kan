...
import com.middlewares.ItemMiddleware;
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?", "Giải tán bang hội", "Lãnh địa Bang Hội", "Kho báu dưới biển", "Đổi điểm");
                    }
                }
            }
...
//                                        
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                createOtherMenu(player, ConstNpc.MENU_DOI_DIEM, String.format("Con đang có %d điểm con muốn làm gì nào?", player.getSession().vip_point), "Đổi hộp\nquà hủy\ndiệt", "Đôi thỏi\nvàng", "Dổi đệ", "Đổi  hồng\nngọc", "Đổi điểm\nvip");
                                break;
                        }
                    } else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_DOI_DIEM) {
                        switch (select) {
                            case 0:
                                // doi hop qua huy diet
                                NpcService.gI().createMenuConMeo(player, ConstNpc.CONFIRM_DOI_HOP_QUQA_HUY_DIET, -1, String.format("Bạn có muốn dùng %d điểm vip để đổi lấy hộp quà hủy diệt không?", ConstItem.PRICE_OF_HOP_QUA_HUY_DIET), "Đồng ý", "Từ chối");
                                break;
                            case 1:
                                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_DOI_DIEM_THANH_THOI_VANG, -1, String.format("Bạn đang có %d điểm bạn muốn đổi bao nhiêu thỏi vàng?", player.getSession().vip_point),
                                        String.format("10 thỏi\nvàng\n(%d điểm)", Util.RedeemPointToItemQuantity(10, ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[0] / ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[1])),
                                        String.format("100 thỏi\nvàng\n(%d điểm)", Util.RedeemPointToItemQuantity(100, ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[0] / ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[1])),
                                        String.format("1000 thỏi\nvàng\n(%d điểm)", Util.RedeemPointToItemQuantity(1000, ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[0] / ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[1])),
                                        String.format("10000 thỏi\nvàng\n(%d điểm)", Util.RedeemPointToItemQuantity(10000, ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[0] / ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[1]))
                                );
                                // doi thoi vang
                                break;
                            case 2:
                                // doi de
                                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_DOI_DIEM_THANH_DE, -1,
                                        String.format("Bạn đang có %d điểm muốn đổi đệ gì?", player.getSession().vip_point),
                                        String.format("Đệ tử\nBeerus\n(4000 điểm)"),
                                        String.format("Đệ tử\nBu\n(2000 điểm)")
                                );
                                break;
                            case 3:
                                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_DOI_DIEM_THANH_HONG_NGOC, -1, String.format("Bạn đang có %d điểm bạn muốn đổi bao nhiêu hồng ngọc?", player.getSession().vip_point),
                                        String.format("100 hồng\nngọc\n(%d điểm)", Util.RedeemPointToItemQuantity(100, ConstItem.TY_LE_DOI_DIEM_RA_HONG_NGOC[1])),
                                        String.format("1000 hồng\nngọc\n(%d điểm)", Util.RedeemPointToItemQuantity(1000, ConstItem.TY_LE_DOI_DIEM_RA_HONG_NGOC[1])),
                                        String.format("10000 hồng\nngọc\n(%d điểm)", Util.RedeemPointToItemQuantity(10000, ConstItem.TY_LE_DOI_DIEM_RA_HONG_NGOC[1])),
                                        String.format("100000 hồng\nngọc\n(%d điểm)", Util.RedeemPointToItemQuantity(100000, ConstItem.TY_LE_DOI_DIEM_RA_HONG_NGOC[1]))
                                );
                                // doi hong ngoc
                                break;
                            case 4:
                                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_DOI_VND_THANH_DIEM, -1, String.format("Bạn đang có %d vnd bạn muốn đổi bao nhiêu điểm?", player.getSession().vnd),
                                        String.format("10 điểm\n(%d vnd)", Util.RedeemPointToItemQuantity(10, ConstItem.TY_LE_DOI_VND_RA_DIEM[1]) * ConstItem.TY_LE_DOI_VND_RA_DIEM[0]),
                                        String.format("100 điểm\n(%d vnd)", Util.RedeemPointToItemQuantity(100, ConstItem.TY_LE_DOI_VND_RA_DIEM[1]) * ConstItem.TY_LE_DOI_VND_RA_DIEM[0]),
                                        String.format("1000 điểm\n(%d vnd)", Util.RedeemPointToItemQuantity(1000, ConstItem.TY_LE_DOI_VND_RA_DIEM[1]) * ConstItem.TY_LE_DOI_VND_RA_DIEM[0]),
                                        String.format("10000 điểm\n(%d vnd)", Util.RedeemPointToItemQuantity(10000, ConstItem.TY_LE_DOI_VND_RA_DIEM[1]) * ConstItem.TY_LE_DOI_VND_RA_DIEM[0])
                                );
                        }
                    }
                }
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                ...
                                "Đổi mật khẩu", "Nhận ngọc xanh", "Cách kiếm vàng", "Kích hoạt\n Tài khoản", "GiftCode");
                    }
                }
            }
                        ...
                        switch (select) {
                            ...
                            case 3:
                                if (!player.getSession().actived) {
                                    int still_point = player.getSession().vip_point;
                                    if (still_point - 100 >= 0) {
                                        player.getSession().actived = true;
                                        player.getSession().vip_point -= 100;
                                        this.npcChat(player, "Kích hoạt thành viên thành công!");
                                    } else {
                                        this.npcChat(player, "Không đủ điểm bạn cần " + (100 - player.getSession().vip_point) + " Điểm nữa");
                                    }
                                } else {
                    ...
                    if (player.iDMark.isBaseMenu()) {
                        ...
                        if (player.zone.map.mapId == 7 && player.idNRNM != -1) {
                            if (player.idNRNM == 353) {
                                if (player.clan != null) {
                                    if (CombineMiddleware.gI().canCallNamecDragon(player)) {
                                    ...
                                    Service.gI().sendThongBao(player, "Bạn không có bang hội không thể gọi.");
                                }
                            } else {
                                Service.gI().sendThongBao(player, "Người ước cần cầm viên 1 sao.");
                            }
                        }
                    }
                }
    ...
    public static Npc bill(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            String.format("Mày còn %d điểm hủy diệt nữa,\nchọn lẹ tao còn đi ngủ", player.getSession().diem_huy_diet),
                            "Mượn phân\n thân",
                            "Tách đồ thần",
                            "Shop Beerus", "Đóng");
                }
                        ...
                        case 48:
                            switch (player.iDMark.getIndexMenu()) {
                                case ConstNpc.BASE_MENU:
                                    if (select == 0) {
                                        createOtherMenu(player, ConstNpc.MENU_DOI_DE_BEERUS_CUA_BILL, "Muốn mượn phân thân của ta à? \n Mang x99 bánh gà , bánh quế với bánh bao đến đây \n có lẽ ta sẽ suy nghĩ lại.", "Có rồi\nnè", "Đợi e đi\nnạp vip..");
                                        break;
                                    }
                                    if (select == 1) {
                                        // tach do than
                                        CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.TACH_DO_THAN);
                                        break;
                                    }
                                    if (select == 2) {
                                    ...
                                    break;
                                case ConstNpc.MENU_DOI_DE_BEERUS_CUA_BILL:
                                    switch (select) {
                                        case 0:
                                            NpcService.gI().createMenuConMeo(player, ConstNpc.CONFIRM_MENU_DOI_DE_BERRUS, -1, "ĐỔi đệ beerus cần  10 điểm hủy diệt và những vật phẩm yêu cầu.", "Đồng ý", "Từ chối");
                                            break;
                                        case 1:
                                            this.npcChat(player, "Tốn thời gian quá đấy mày.");
                                            break;
                                    }
                                    break;
                                case ConstNpc.CONFIRM_TACH_DO_THAN:
                                    if (select == 0) {
                                        CombineServiceNew.gI().startCombine(player);
                                    }
                                    break;
                    ...
                    if (this.mapId == 112) {
                        if (player.iDMark.getIndexMenu() == 0) { //
                            switch (select) {
                                ...
                                case 1:  //
                                    this.createOtherMenu(player, 1,
                                            "Bạn có muốn đổi" + ConstItem.DIEM_DOI_CAI_TRANG_PVP + "điểm PVP lấy \n|6|Cải trang Mèo Kid Lân với chỉ số ngẫu nhiên lên đến 120% không?\n ", "Ok", "Không");
                                    // bat menu doi item
                                    break;
                        ...
                        if (player.iDMark.getIndexMenu() == 1) { // action doi item
                            switch (select) {
                                case 0: // trade
                                    if (player.pointPvp >= ConstItem.DIEM_DOI_CAI_TRANG_PVP) {
                                        player.pointPvp -= ConstItem.DIEM_DOI_CAI_TRANG_PVP;
                                        Item item = ItemService.gI().createNewItem((short) (1104));
                                        item.itemOptions.add(new Item.ItemOption(49, Util.nextInt(30, 120)));
                                        item.itemOptions.add(new Item.ItemOption(77, Util.nextInt(30, 120)));
                                        item.itemOptions.add(new Item.ItemOption(103, Util.nextInt(30, 120)));
                                        item.itemOptions.add(new Item.ItemOption(207, 0));
                                        item.itemOptions.add(new Item.ItemOption(33, 0));
//                                      
                                        InventoryServiceNew.gI().addItemBag(player, item);
                                        ...
                                        Service.gI().sendThongBao(player, "Không đủ điểm bạn còn cần " + (ConstItem.DIEM_DOI_CAI_TRANG_PVP - player.pointPvp) + " Điểm nữa");
                                    }
                                    break;
                            }
                        }
...
//                                ShopService.gI().openShopNormal(player, this, ConstNpc.SHOP_BUNMA_TL_0, 0, player.gender);
    ...
    public static void createNpcConMeo() {
        Npc npc = new Npc(-1, -1, -1, -1, ConstNpc.CON_MEO, 351) {
            ...
            public void confirmMenu(Player player, int select) {
                switch (player.iDMark.getIndexMenu()) {
                    case ConstNpc.CONFIRM_MENU_DOI_DE_BERRUS:
                        if (select == 0) {
                            CombineMiddleware.gI().ChangeBeerusPet(player, this);
                        }
                        break;
                    case ConstNpc.CONFIRM_DOI_HOP_QUQA_HUY_DIET:
                        if (select == 0) {
                            if (player.getSession().vip_point >= ConstItem.PRICE_OF_HOP_QUA_HUY_DIET) {
                                RedeemPointService.gI().doiHopQuaHuyDiet(player);
                            } else {
                                Service.gI().sendThongBao(player, "Bạn không đủ điểm");
                            }
                        }
                        break;
                    case ConstNpc.MENU_DOI_DIEM_THANH_THOI_VANG:
                        int itemPoint = -1;
                        switch (select) {
                            case 0:
                                // doi 10 diem
                        ...
                        if (itemPoint != -1) {
                            if (player.getSession().vip_point - itemPoint >= 0) {
                                int quantity = Util.RedeemPointToItemQuantity(itemPoint, ((float) ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[0] / (float) ConstItem.TY_LE_DOI_DIEM_RA_THOI_VANG[1]));
                                Service.gI().sendItemToPlayer(player, 457, quantity, new ArrayList<>());
                                player.getSession().vip_point -= itemPoint;
                            } else {
                                Service.gI().sendThongBao(player, "Bạn không đủ điểm");
                            }
                        ...
                        break;
                    case ConstNpc.MENU_DOI_DIEM_THANH_HONG_NGOC:
                        int itemPoint1 = -1;
                        switch (select) {
                            case 0:
                                // doi 10 diem
                        ...
                        if (itemPoint1 != -1) {
                            if (player.getSession().vip_point - (itemPoint1) >= 0) {
                                int quantity = Util.RedeemPointToItemQuantity(itemPoint1, (float) ConstItem.TY_LE_DOI_DIEM_RA_HONG_NGOC[0] / (float) ConstItem.TY_LE_DOI_DIEM_RA_HONG_NGOC[1]);
                                InventoryServiceNew.gI().addRuby(player, quantity);
                                player.getSession().vip_point -= itemPoint1;
                            } else {
                                Service.gI().sendThongBao(player, "Bạn không đủ diểm.");
                            }
                        }
                        break;
                    case ConstNpc.MENU_DOI_VND_THANH_DIEM:
                        int itemPoint2 = -1;
                        switch (select) {
                            case 0:
                                // doi 10 diem
                        ...
                        if (itemPoint2 != -1) {
                            if (player.getSession().vnd - (itemPoint2 * ConstItem.TY_LE_DOI_VND_RA_DIEM[0]) >= 0) {
                                int quantity = Util.RedeemPointToItemQuantity(itemPoint2 * ConstItem.TY_LE_DOI_VND_RA_DIEM[0], ConstItem.TY_LE_DOI_VND_RA_DIEM[0]);
                                // update database
                                player.getSession().vnd -= itemPoint2;
                                GodGK.updateVnd(player);
                                player.getSession().vip_point += quantity;
                                Service.gI().sendThongBao(player, String.format("Bạn nhận được %d điểm", quantity));
                    ...
                    case ConstNpc.MENU_DOI_DIEM_THANH_DE:
                        switch (select) {
                            case 0:
                                // doi de berrus
                                if (player.getSession().vip_point - ConstItem.GIA_DE_TU_BERRUS >= 0) {
                                    if (player.pet != null) {
                                        if (player.pet.typePet == 2) {
                                            Service.gI().sendThongBao(player, "Bạn đã có đệ beerus rồi.");
                                            return;
                                        }
                                    ...
                                    Service.gI().sendThongBao(player, "Đổi đệ berrus thành công");
                                    player.getSession().vip_point -= ConstItem.GIA_DE_TU_BERRUS;
                                } else {
                                    Service.gI().sendThongBao(player, "Bạn không đủ điểm");
                                }
                                break;
                            case 1:
                                if (player.getSession().vip_point - ConstItem.GIA_DE_TU_BU >= 0) {
                                    if (player.pet != null) {
                                        if (player.pet.typePet == 1) {
                                            Service.gI().sendThongBao(player, "Bạn đã có đệ buu rồi.");
                                            return;
                                        }
                                    ...
                                    Service.gI().sendThongBao(player, "Đổi đệ mabu thành công");
                                    player.getSession().vip_point -= ConstItem.GIA_DE_TU_BU;
                                } else {
                                    Service.gI().sendThongBao(player, "Bạn không đủ điểm");
                                }
                                break;
                        ...
                        break;
                    case ConstNpc.MENU_CHON_DO_HUY_DIET:
                        int type = -1;
                        switch (select) {
                            case 0:
                                type = ConstItem.WEAPON_TYPE_GANG;
                                break;
                            case 1:
                                type = ConstItem.WEAPON_TYPE_QUAN;
                                break;
                            case 2:
                                type = ConstItem.WEAPON_TYPE_AO;
                                break;
                            case 3:
                                type = ConstItem.WEAPON_TYPE_GIAY;
                                break;
                            case 4:
                                type = ConstItem.WEAPON_TYPE_NHAN;
                                break;
                        }
                        if (type != -1) {
                            ItemMiddleware.gI().sendItemHuyDiet(type, player);
                        }
                        break;
                    case ConstNpc.IGNORE_MENU:
